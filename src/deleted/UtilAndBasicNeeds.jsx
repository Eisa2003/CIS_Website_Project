    ...
    <div className="card-resources">
      ...
      <div className={`card-container ${isFlipped1 ? 'flip' : ''}`} onClick={toggleCardFlip1}>
        <div className="cardR card-front">
          ...
          <img alt ="" src="https://www.fbcwinston.org/wp-content/uploads/2016/06/FBC-logo.jpg" 
          style={{ width: '250px', height: '130px' }} />
        </div>
        <div className="cardR card-back">
            <p>
              <strong>Clothes Closet Program</strong> <br />
              <strong>Phone: </strong> <a href="tel:+8039433758">(803) 943-3758</a><br />        
            </p>
      ...
      <div className={`card-container ${isFlipped2 ? 'flip' : ''}`} onClick={toggleCardFlip2}>
        <div className="cardR card-front">
          <h3>Lawtonville Baptist Church</h3>
          <img alt ="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTr70zkMHaF_i5x114B2vtuYQdo2K5PLaSjvw&s" 
      ...
      <div className={`card-container ${isFlipped3 ? 'flip' : ''}`} onClick={toggleCardFlip3}>
        <div className="cardR card-front">
          <h3>Lowcountry Community Action Agency </h3>
          <img alt ="" src="https://www.lowcountrycaa.org/images/design/main/slogan.png" 
        ...
        <div className="cardR card-back">
            <p>
              ...
              <strong>Phone:</strong> <a href="tel:+8039140601">(803) 914-0601</a><br />
              <strong>Website:</strong> <a class="linkweb" href="https://www.lowcountrycaa.org/" target="_blank" rel="noreferrer">www.lowcountrycaa.org</a><br />
      ...
      <div className={`card-container ${isFlipped4 ? 'flip' : ''}`} onClick={toggleCardFlip4}>
        <div className="cardR card-front">
          <h3>Salvation Army of the Lowcountry (Assists Hampton County residents)</h3>
          <img alt ="" src="https://static.salvationarmy.org/us-east-1/templates/symphony/static_resources/images/global/shield-en.svg" 
        ...
        <div className="cardR card-back">
            <p>
              ...
              <strong>Phone:</strong> <a href="tel:+8435243727">(843) 524-3727</a><br />
              <strong>Email:</strong> <a href="mailto:BeaufortSC@uss.salvationarmy.org">BeaufortSC@uss.salvationarmy.org</a> <br />
              <strong>Website:</strong> <a class="linkweb" href="https://southernusa.salvationarmy.org/lowcountry/" target="_blank" rel="noreferrer">www.southernusa.salvationarmy.org/lowcountry/</a><br />
              <strong>Services: </strong>
              <ul>
                <li>Food Pantry </li>
        ...
        <div className={`card-container ${isFlipped5 ? 'flip' : ''}`} onClick={toggleCardFlip5}>
                <div className="cardR card-front">
                  <h3>FSc211.org or dial 211 </h3>
                  <img alt ="" src="https://www.211.org/themes/custom/uw211/assets/images/home-logo.svg" 
                  style={{ width: '200px', height: '150px' }} />
                </div>
                <div className="cardR card-back">
                    <p>
                      <strong>Mission: </strong><br />
                      <br /><a href="tel:+211">2‑1‑1</a> is a free telephone number providing access to local community services. <br />
                      <br /><a href="tel:+211">2‑1‑1</a> is available in multiple languages, allowing those in need to access information and obtain referrals 
