...
export default function EmpAndEdu() {
  ...
  return (
    <div className="card-resources">
      ...
      <div className={`card-container ${isFlipped1 ? 'flip' : ''}`} onClick={toggleCardFlip1}>
        <div className="cardR card-front"><br />
          <h3>Adult Education</h3>
            <img src="https://www.wsav.com/wp-content/uploads/sites/75/2020/07/Jasper-County-School-District.png?w=1280" alt="Card 1 " style={{ width: '150px', height: '150px' }} />
        </div>
        <div className="cardR card-back">
          <p>
            <strong>Address:</strong> <a class="link" href="https://www.google.com/maps/place/303+1st+St+E,+Hampton,+SC+29924/@32.866367,-81.1103782,17z/data=!3m1!4b1!4m6!3m5!1s0x88f95c3a62a028d5:0xd5cad4490423ce7!8m2!3d32.866367!4d-81.1078033!16s%2Fg%2F11c23w5_tx?entry=ttu" target="_blank" rel="noopener noreferrer">303 1st St E, Hampton, SC 29924</a><br />
            <strong>Phone:</strong> <a href="tel:+8039031052">(803) 903-1052</a><br />
            <strong>Contact:</strong> Diane Cuyler<br />
            <strong>Website:</strong> <a class="linkweb
            ." href="https://www.jcsd.net/apps/pages/JAHAAdultEducation" target="_blank" rel="noopener noreferrer">JAHA Adult Education</a>
          </p>
        </div>
      </div>
      ...
      <div className={`card-container ${isFlipped2 ? 'flip' : ''}`} onClick={toggleCardFlip2}>
        <div className="cardR card-front">
          <h3>Avery C. Thompson, Sr. Community Center</h3>
          <img src="https://img1.wsimg.com/isteam/ip/0201aa70-dd41-426c-bcdd-0c748b15feba/blob-5ec37ce.png/:/cr=t:0%25,l:0%25,w:100%25,h:100%25/rs=w:700,cg:true" alt="Card 1 " style={{ width: '150px', height: '150px' }} />
        </div>
        <div className="cardR card-back">
          <p>
            <strong>Address:</strong> <a class="link" href="https://www.google.com/maps/place/63+E+Palmetto+Ave,+Varnville,+SC+29944/@32.8503371,-81.0838553,17z/data=!3m1!4b1!4m10!1m2!2m1!1s63+East+Palmetto+Ave,+Post+Office+Box+601,+Varnville,+SC+29944!3m6!1s0x88f95c01d81ae07d:0x72dc2e3e55170c5a!8m2!3d32.8503327!4d-81.0789844!15sCj42MyBFYXN0IFBhbG1ldHRvIEF2ZSwgUG9zdCBPZmZpY2UgQm94IDYwMSwgVmFybnZpbGxlLCBTQyAyOTk0NJIBEGdlb2NvZGVkX2FkZHJlc3PgAQA!16s%2Fg%2F11h0_ld44m?entry=ttu">63 East Palmetto Ave, Post Office Box 601, Varnville, SC 29944</a><br />
            <strong>Phone:</strong> <a href="tel:+8038426316">(803) 842-6316 </a> <br />
      ...
      <div className={`card-container ${isFlipped3 ? 'flip' : ''}`} onClick={toggleCardFlip3}>
        <div className="cardR card-front">
          <h3>Communities in Schools</h3>
          <img src="data:image/png;base64," alt="Card 1 " style={{ width: '150px', height: '150px' }} />
        </div>
        <div className="cardR card-back">
          <p>
      ...
      <div className={`card-container ${isFlipped4 ? 'flip' : ''}`} onClick={toggleCardFlip4}>
        <div className="cardR card-front">
          <h3>First Steps</h3>
          <img src="https://hamptonfirststeps.org/wp-content/uploads/2020/02/hamptonlogosmaller.png?w=300" alt="Card 1 " style={{ width: '150px', height: '150px' }} />
        </div>
        <div className="cardR card-back">
          <p>
            <strong>Address:</strong> <a class="link" href="https://www.google.com/maps/place/301+1st+St+E,+Hampton,+SC+29924/@32.8665962,-81.1076908,17z/data=!3m1!4b1!4m6!3m5!1s0x88f95c3a63bb4cdf:0x2248736e02c23b8f!8m2!3d32.8665962!4d-81.1076908!16s%2Fg%2F11c1dgtqtm?entry=ttu">301 First Street East, Hampton, SC 29924</a><br />
            <strong>Phone:</strong> <a href="tel:+8039437127">(803) 943-7127</a><br />
            <strong>Contact:</strong> Dwanda Doctor, Executive Director<br />
            <strong>Website:</strong> <a class="linkweb" href="https://hamptonfirststeps.org/" target="_blank" rel="noopener noreferrer">www.hamptonfirststeps.org</a><br />
      ...
      <div className={`card-container ${isFlipped5 ? 'flip' : ''}`} onClick={toggleCardFlip5}>
        <div className="cardR card-front">
          <h3>Healthy Learners</h3>
          <img src="https://healthylearners.com/wp-content/uploads/2020/07/HealthyLearners_Webpage_Logo-2048x318.png" alt="Card 1 " style={{ width: '400px', height: '150px' }} />
        </div>
        <div className="cardR card-back">
          <p>
            <strong>Contact:</strong> Shelly Thomas, RN, ADN, Program Manager Lowcountry<br />
            <strong>Phone:</strong> <a href="tel:+8035848613">(803) 584-8613</a> <br /> 
            <strong>Website:</strong> <a class="linkweb" href="https://healthylearners.com/" target="_blank" rel="noopener noreferrer">www.healthylearners.com</a><br />
      ...
      <div className={`card-container ${isFlipped6 ? 'flip' : ''}`} onClick={toggleCardFlip6}>
        ...
        <div className="cardR card-back">
          <p>
            ...
            <strong>Phone:</strong> <a href="tel:+8039434576">(803) 943-4576</a>  <br /> 
            <strong>Email:</strong> <a href="mailto:LDarien@hcsdsc.org">LDarien@hcsdsc.org</a><br />
            <strong>Website:</strong> <a class="linkweb" href="https://www.hampton2.k12.sc.us/departments/office_of_student_services" target="_blank" rel="noopener noreferrer">www.hampton2.k12.sc.us/departments/</a><br />
    ...
    <div className={`card-container ${isFlipped7 ? 'flip' : ''}`} onClick={toggleCardFlip7}>
        <div className="cardR card-front">
          <h3>SC Works: WIOA Program</h3> <br />
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcScuj5_aBR4xBcByK57EhGwwiiUW0QT-TSq1w&s" alt="Card 1 " style={{ width: '150px', height: '150px' }} />
        </div>
          <div className="cardR card-back">
            <p>
            <strong>Contact:</strong> Shelia Bovain, Career Specialist <br />
            <strong>Address:</strong> <a class="link" href="https://www.google.com/maps/place/54+Tech+Cir,+Varnville,+SC+29944/@32.8623589,-81.0862294,17z/data=!3m1!4b1!4m6!3m5!1s0x88f95c0ffea16bcd:0xe2bc3eb2a19f68dc!8m2!3d32.8623589!4d-81.0862294!16s%2Fg%2F11c0_8y9jh?entry=ttu">54 Tech Circle, Varnville, SC 29944</a><br />
            <strong>Phone:</strong> <a href="tel:+8432269254 ">(843) 226-9254 </a> <br /> 
            <strong>Email:</strong> <a href="mailto:sbovain@rossworks.com">sbovain@rossworks.com</a><br />
            <strong>Website:</strong> <a class="linkweb" href="https://www.lowcountrycog.org/workforce/our_services/index.php" target="_blank" rel="noopener noreferrer">www.lowcountrycog.org/workforce/our_services/</a><br />
    ...
    <div className={`card-container ${isFlipped8 ? 'flip' : ''}`} onClick={toggleCardFlip8}>
        <div className="cardR card-front">
          <h3>TT&T Services </h3>
          <img alt="" src="https://media.istockphoto.com/id/519749080/photo/help-support-advice-guidance-signpost.jpg?s=612x612&w=0&k=20&c=hXetfeUaFCs0vet3Jxl3iTwtUGv-mtsN-9KiFzfxlMI=" 
          style={{ width: '150px', height: '150px' }} />
        </div>
        <div className="cardR card-back">
          <p>
            <strong>Contact:</strong> Ms. Dominic Rivers, Case Manager  <br />
            <strong>Phone:</strong> <a href="tel:+4435838873 ">(443) 583-8873 </a>  <br /> 
