  ...
  return (
    <div className="card-resources">
      ...
      <div className={`card-container ${isFlipped1 ? 'flip' : ''}`} onClick={toggleCardFlip1}>
        <div className="cardR card-front">
          ...
          <img src="https://dss.sc.gov/img/logo.png" alt="Card 1 " style={{ width: '285px', height: '95px' }} />
        </div>
      ...
      <div className={`card-container ${isFlipped2 ? 'flip' : ''}`} onClick={toggleCardFlip2}>
        <div className="cardR card-front">
          ...
          <img src="https://img1.wsimg.com/isteam/ip/af6c148b-3a10-42e2-89b2-f70bc042dba0/Cherry%20Grove%20church%20logo.jpg/:/cr=t:0.08%25,l:0%25,w:100%25,h:99.84%25/rs=w:365,h:365,cg:true" alt="Card 1 " style={{ width: '150px', height: '150px' }} />
        </div>
        <div className="cardR card-back">
          <p>
      ...
      <div className={`card-container ${isFlipped3 ? 'flip' : ''}`} onClick={toggleCardFlip3}>
        <div className="cardR card-front">
          ...
          <img src="https://img1.wsimg.com/isteam/ip/25136b0d-8b8d-4dde-b935-ec297ac09b1c/1ST%20BAPTIST%20CHURCH%20LOGO.png/:/rs=h:139,cg:true,m/qt=q:95" alt="Card 1 " 
      ...
      <div className={`card-container ${isFlipped4 ? 'flip' : ''}`} onClick={toggleCardFlip4}>
        <div className="cardR card-front">
          ...
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTImbewG7VVNPzh78da7pWgxy9TNGbGZMRqlQ&s" alt="Card 1 " 
      ...
      <div className={`card-container ${isFlipped5 ? 'flip' : ''}`} onClick={toggleCardFlip5}>
        <div className="cardR card-front">
          ...
          <img src="https://img1.wsimg.com/isteam/ip/dbdab07e-112c-4236-95ea-cb188f3dee3c/Color%20logo%20with%20background.png/:/rs=w:208,h:200,cg:true,m/cr=w:208,h:200/qt=q:95" alt="Card 1 " 
          style={{ width: '150px', height: '150px' }} />
        </div>
        <div className="cardR card-back">
        <p>
      ...
      <div className={`card-container ${isFlipped6 ? 'flip' : ''}`} onClick={toggleCardFlip6}>
        <div className="cardR card-front">
          ...
          <img alt="" src="https://resources.finalsite.net/images/f_auto,q_auto/v1644944742/hampton1k12scus/siiklwxts161eil1h8uq/H_black.png" 
          style={{ width: '150px', height: '150px' }} />
        </div>
        <div className="cardR card-back">
            <p>
    ...
    {/* Card 9- Huspah Missionary Baptist Church Ministries*/}
      <div className={`card-container ${isFlipped9 ? 'flip' : ''}`} onClick={toggleCardFlip9}>
        <div className="cardR card-front">
          ...
          <img alt="" src="https://media.istockphoto.com/id/1035198222/photo/globe-and-black-bible.jpg?s=612x612&w=0&k=20&c=JGXunfy73dr2HuY5x4HqXjPSOtUyQVslhqD4B-d6GZs=" 
          style={{ width: '150px', height: '150px' }} />
        </div>
        <div className="cardR card-back">
          <p>
      ...
      <div className={`card-container ${isFlipped10 ? 'flip' : ''}`} onClick={toggleCardFlip10}>
        <div className="cardR card-front">
          ...
          <img alt="" src="https://media.istockphoto.com/id/1219384600/photo/religion-in-africa.jpg?s=612x612&w=0&k=20&c=3oCFaG00cSVbghUxk9siTKS-37z_-g2L8wpsh_WXDF8=" 
      ...
      <div className={`card-container ${isFlipped11 ? 'flip' : ''}`} onClick={toggleCardFlip11}>
        <div className="cardR card-front">
          ...
          <img alt="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS1Y95S3hBNZpl9eBp7NViZ4pyiNoyHZkGmPQ&s" 
      ...
      <div className={`card-container ${isFlipped12 ? 'flip' : ''}`} onClick={toggleCardFlip12}>
        <div className="cardR card-front">
          ...
          <img alt="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTHpaBpJnOG3_DMwzBzws-sTMPaOpEuN5tR_g&s" 
          style={{ width: '150px', height: '150px' }} />
        </div>
        <div className="cardR card-back">
          <p>
      ...
      <div className={`card-container ${isFlipped13 ? 'flip' : ''}`} onClick={toggleCardFlip13}>
        <div className="cardR card-front">
          ...
          <img alt="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4L5TmC61Zl0nATFs3AexXCEfUwckFYTyEIQ&s" 
          style={{ width: '150px', height: '150px' }} />
        </div>
        <div className="cardR card-back">
          <p>
      ...
      <div className={`card-container ${isFlipped14 ? 'flip' : ''}`} onClick={toggleCardFlip14}>
        <div className="cardR card-front">
          ...
          <img alt="" src="https://miraclesarehappeningnow.com/wp-content/uploads/2022/09/Miracles-Are-Happening-Now-Worship-Center-Logo.png" 
          style={{ width: '150px', height: '150px' }} />
        </div>
        <div className="cardR card-back">
          <p>
    ...
    <div className={`card-container ${isFlipped15 ? 'flip' : ''}`} onClick={toggleCardFlip15}>
        <div className="cardR card-front">
          ...
          <img alt="" src="https://images.squarespace-cdn.com/content/v1/5f7f5023eade434a97d38d93/1603719778099-HRJL8TMLHRD25GI4MUXS/Greater+Faith+LOGO+mockups+4+%282%29.png?format=1500w" 
          style={{ width: '150px', height: '150px' }} />
        </div>
          <div className="cardR card-back">
            <p>
    ...
    <div className={`card-container ${isFlipped16 ? 'flip' : ''}`} onClick={toggleCardFlip16}>
        <div className="cardR card-front">
          ...
          <img alt="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTA_d_CNP-iFpXcJuCbh2ruAp_x9cfGBomX5g&s" style={{ width: '150px', height: '150px' }} />
    ...
    <div className={`card-container ${isFlipped17 ? 'flip' : ''}`} onClick={toggleCardFlip17}>
            <div className="cardR card-front">
              ...
              <img alt="" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQTbuAYKR8qLgaNt6jxJYw64zU5Xmd7d76RAw&s" 
              style={{ width: '150px', height: '150px' }} />
            </div>
            <div className="cardR card-back">
              <p>
