    ...
    <div className="card-resources">
      ...
      <div className={`card-container ${isFlipped1 ? 'flip' : ''}`} onClick={toggleCardFlip1}>
        <div className="cardR card-front">
          ...
          <img src="https://familypromisebeaufortcounty.org/wp-content/uploads/2024/04/GD-2024-Image-1160x773.jpg" alt="Card 1 Image" 
        ...
        <div className="cardR card-back">
          <p>
            ...
            <strong>Phone:</strong> <a href="tel:+8438154211">(843) 815-4211</a><br />
      ...
      <div className={`card-container ${isFlipped2 ? 'flip' : ''}`} onClick={toggleCardFlip2}>
        <div className="cardR card-front">
          ...
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcScryo7b3m---kTKL-QPSMhmY5rtMBhmo9-OA&s" alt="Card 1 Image" 
          style={{ width: '200px', height: '150px' }} />
        </div>
        <div className="cardR card-back">
          <p>
            ...
            <strong>Phone:</strong><a href="tel:+8435999270"> (843) 599-9270</a><br />
