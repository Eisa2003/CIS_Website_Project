      ...
      <div className={`card-container ${isFlipped6 ? 'flip' : ''}`} onClick={toggleCardFlip6}>
        ...
        <div className="cardR card-back">
          <p>
            ...
            <strong>Website:</strong> <a href="https://www.hampton2.k12.sc.us/departments/office_of_student_services" target="_blank" rel="noopener noreferrer">https://www.hampton2.k12.sc.us/departments/</a><br />
    ...
    <div className={`card-container ${isFlipped7 ? 'flip' : ''}`} onClick={toggleCardFlip7}>
        <div className="cardR card-front">
          ...
          <div className="cardR card-back">
            ...
            <strong>Website:</strong> <a href="https://www.lowcountrycog.org/workforce/our_services/index.php" target="_blank" rel="noopener noreferrer">https://www.lowcountrycog.org/workforce/our_services/</a><br />
