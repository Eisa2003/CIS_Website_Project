    ...
    <div className="card-resources">
      ...
      <div className={`card-container ${isFlipped1 ? 'flip' : ''}`} onClick={toggleCardFlip1}>
        <div className="cardR card-front">
          ...
          <img src="https://www.girlscoutsesc.org/content/dam/girlscouts-shared-redesign/images/2021-logos-original/girlscoutsesc-green.png" 
      ...
      <div className={`card-container ${isFlipped4 ? 'flip' : ''}`} onClick={toggleCardFlip4}>
        <div className="cardR card-front">
          ...
          <img src="https://static.wixstatic.com/media/02c894_ece4477ee46a49b2b6dea17fd5284c5a~mv2.jpeg/v1/fill/w_163,h_189,al_c,q_80,usm_0.66_1.00_0.01,enc_auto/CJ%20logo.jpeg" 
