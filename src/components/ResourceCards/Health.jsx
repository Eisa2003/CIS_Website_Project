    ...
    <div className="card-resources">
      ...
      <div className={`card-container ${isFlipped1 ? 'flip' : ''}`} onClick={toggleCardFlip1}>
        <div className="cardR card-front">
          ...
          <img src="https://lh3.googleusercontent.com/p/AF1QipP1KFURa21M2Hzlx7fdjTSbeqLIqrHntEOoXgq7=s1360-w1360-h1020" alt="Card 1 Image" 
      ...
      <div className={`card-container ${isFlipped2 ? 'flip' : ''}`} onClick={toggleCardFlip2}>
        <div className="cardR card-front">
          <h3>Needy Meds</h3>
          <img src="https://www.needymeds.org/_next/image?url=%2F_next%2Fstatic%2Fimage%2Fpublic%2Fimages%2Flogo.eb919830505a8cb24ad4c2d0d8c56cee.png&w=128&q=75" alt="Card 1 Image" 
